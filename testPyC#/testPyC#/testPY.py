...
my_loaded_model = joblib.load("C:/Users/simog/Downloads/NASA-Turbofan-Jet-Engine-RUL-prediction-C-MAPSS-main/NASA-Turbofan-Jet-Engine-RUL-prediction-C-MAPSS-main/Failure prediction/C-MAPSS1.pkl")
